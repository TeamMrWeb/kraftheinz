export default function Hero() {
  return (
    <div className="w-full flex relative bg-black h-[256px] md:h-[400px]">
      <div
        className="w-full bg-local bg-[center_bottom_-90vw] md:bg-[center_top_-15vw] lg:bg-[center_top_-25vw] xl:bg-[center_top_-30vw] 2xl:bg-[center_top_-35vw] bg-no-repeat bg-cover relative flex justify-center items-center background"
        style={{
